...
const Home = () => {
  ...
  const hard_games = [{name: "Minecraft", rank: 1, id: 0, 
                       description: "Minecraft is a sandbox video game developed by Mojang. The game was created by Markus \"Notch\" Persson in the Java programming language.", image: "https://s2.gaming-cdn.com/images/products/442/orig/minecraft-cover.jpg"},
                      {name: "World of Warcraft", rank: 2, id: 1, 
                      ...
                      {name: "Elite Dangerous", rank: 3, id: 2, 
                       description: "Elite Dangerous is a space flight simulation game developed and published by Frontier Developments. Piloting a spaceship, the player explores a realistic 1:1 scale open-world representation of the Milky Way galaxy, with the gameplay being open-ended."},
                      {name: "Sea of Thieves", rank: 4, id: 3, 
                       description: "Sea of Thieves is a 2018 action-adventure game developed by Rare and published by Xbox Game Studios. The player assumes the role of a pirate who completes voyages from different trading companies in order to become the ultimate pirate legend."},
                      {name: "Among Us", rank: 5, id: 4, 
                      ...
                      {name: "Sea of Thieves", rank: 6, id: 5, 
                       description: "Sea of Thieves is a 2018 action-adventure game developed by Rare and published by Xbox Game Studios. The player assumes the role of a pirate who completes voyages from different trading companies in order to become the ultimate pirate legend."},
                      {name: "Sea of Thieves", rank: 7, id: 6, 
                       description: "Sea of Thieves is a 2018 action-adventure game developed by Rare and published by Xbox Game Studios. The player assumes the role of a pirate who completes voyages from different trading companies in order to become the ultimate pirate legend."},
                      {name: "Sea of Thieves", rank: 8, id: 7, 
    ...
    <main className="mainContainer">
        ...
        <section className="infoContainer">
          <div className="upperInfo">
            <p className="infoParagraph">{infoText}</p>
          </div>
          <div className="lowerInfo">
            <img className="infoImage" src={infoImageSrc}></img>
          </div>
        </section>      
    </main>
